...
urlpatterns = [
    ...
    path('ajax/get_attendance_results', dashboardController.student_attendance_detail, name='student_attendance_detail'),
    path('upload_video/', dashboardController.upload_video, name='upload_video'),
